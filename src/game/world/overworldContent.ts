...
const APPROACH_PROPS: WorldProp[] = [
	...
	{ id: 'guard-1', kind: 'guard', x: 2645, y: 1335, sortY: 1355, scale: 1, collisionRadius: 16 },
	{ id: 'guard-2', kind: 'guard', x: 2660, y: 1465, sortY: 1485, scale: 1, collisionRadius: 16 },
	{ id: 'guard-3', kind: 'guard', x: 2740, y: 1315, sortY: 1335, scale: 1, collisionRadius: 16 },
	{ id: 'guard-4', kind: 'guard', x: 2740, y: 1485, sortY: 1505, scale: 1, collisionRadius: 16 },
